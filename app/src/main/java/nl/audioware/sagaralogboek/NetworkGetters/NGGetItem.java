...
public class NGGetItem {
    DefaultNetGetter netGetter;

    public NGGetItem(final Activity activity, String BaseUrl, String User, String iv, int id){
        String url = BaseUrl + "Scripts/Item.php?action=Get";
        ...
        netGetter = new DefaultNetGetter(activity, url, params){
            ...
            public void ActionDone(String response, final Context context){
                try {
                    ...
                    ((ItemActivity)activity).insertData(JsonResponse);
